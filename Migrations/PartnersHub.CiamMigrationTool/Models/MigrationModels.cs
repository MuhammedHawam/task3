...
public class CiamUserResponse {
    ...
    // Make emails property flexible to handle different JSON structures
    [JsonPropertyName("emails")]
    public List<object> EmailsRaw { get; set; } = new();

    // Helper property to get emails as strings
    [JsonIgnore]
    public List<string> Emails => EmailsRaw?.Select(e => e.ToString()).Where(s => !string.IsNullOrEmpty(s)).ToList() ?? new List<string>();
