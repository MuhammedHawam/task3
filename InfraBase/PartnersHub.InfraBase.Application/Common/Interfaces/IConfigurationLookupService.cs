...
public interface IConfigurationLookupService
{
    ...
    Task<IReadOnlyDictionary<string, string>> GetAssetTypeSearchValuesAsync(CancellationToken cancellationToken = default);
    Task<IReadOnlyDictionary<string, Guid>> GetAssetTypeIdsByCodeAsync(CancellationToken cancellationToken = default);
