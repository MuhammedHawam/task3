...
namespace PartnersHub.InfraBase.Infrastructure.Persistence.Migrations._20251123004903
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetAttachments_Assets_AssetId1",
                        column: x => x.AssetId1,
                        principalTable: "Assets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetCapexDetails_Assets_AssetId1",
                        column: x => x.AssetId1,
                        principalTable: "Assets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetHistories_Assets_AssetId1",
                        column: x => x.AssetId1,
                        principalTable: "Assets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetOpexDetails_Assets_AssetId1",
                        column: x => x.AssetId1,
                        principalTable: "Assets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetAttachments_AssetId1",
                table: "AssetAttachments",
                column: "AssetId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetCapexDetails_AssetId1",
                table: "AssetCapexDetails",
                column: "AssetId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetHistories_AssetId1",
                table: "AssetHistories",
                column: "AssetId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetOpexDetails_AssetId1",
                table: "AssetOpexDetails",
                column: "AssetId1");
        }
