...
namespace PartnersHub.InnovationHub.Application.Common.Interfaces
{
    ...
    {
        Task SendChallengeSubmittedNotificationAsync(Guid ChallengeRequestId, string challengeName, CancellationToken cancellationToken = default);
        Task SendChallengeApprovedNotificationAsync(Guid challengeRequestId, string challengeName, string submitterEmail, CancellationToken cancellationToken = default);

        Task SendChallengeReturnedNotificationAsync(Guid challengeRequestId, string challengeName,  string submitterEmail, string returnedReason, CancellationToken cancellationToken = default);

        Task SendChallengeLinkedTechnologyNotificationAsync(Guid challengeRequestId, string challengeName, string submitterEmail, string technology, CancellationToken cancellationToken = default);
